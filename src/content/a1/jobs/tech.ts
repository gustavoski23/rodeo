...
export const PACK_TECH: JobPack = {
  ...
  emoji: '💻',
  intro_es: [
    'Ah, tú eres de los que programan. Tranquilo, ese inglés es más fácil de lo que parece.',
  ...
  units: [
    {
      ...
      scenes: [
        {
          ...
          icon: '⏱️',
          setup_es: [
            'El standup es cortito y siempre igual: qué hiciste ayer, qué haces hoy, qué te tiene trabado.',
          ...
          chunks: [
            ...
            },
            {
              ...
              why_es: 'La segunda del standup. Ojo al cambio de sabor: ayer se acabó, hoy está pasando justo ahora — por eso suena distinto aunque sea el mismo cuento. Como decir "ayer llovió" y "hoy está lloviendo".',
            ...
            },
            {
              ...
              why_es: 'La tercera del standup, y la más importante. Decir que estás trabado NO es confesar que eres malo: es encender las luces de emergencia pa\' que alguien pare a ayudarte. El que se queda callado dos días es el que queda mal.',
            ...
            },
            {
              ...
              why_es: 'La respuesta de "todo bien, sigo". "On my side" es "por mi lado": marcas tu pedacito de cancha y no respondes por el de los demás. Cortita, y cierras tu turno sin enredarte.',
          ...
          chunks: [
            {
              ...
              why_es: '"bug" es bicho: en inglés se lo imaginan como un animalito metido en la máquina dañándola. Dilo con el DÓNDE pegado (in production, in the login) — sin el dónde, el aviso no sirve pa\' nada.',
        ...
        },
        {
          ...
          chunks: [
            ...
            },
            {
              ...
              why_es: 'El aviso de "listo, ya está arriba". Cortita y con peso: cierra el asunto y le dice al equipo que puede seguir. Sin este aviso, el bug sigue vivo en la cabeza de todos aunque tú ya lo hayas matado.',
      ...
      task: {
        ...
        steps: [
          ...
          {
            goal_es: 'Se cayó algo en producción. Avísale al equipo.',
            answerChunkId: 'c-tech-found-a-bug',
            reaction_es: 'Perfecto, y con el "in production" pegado. Así saben dónde buscar.',
          },
          {
            goal_es: 'Llevas dos horas pegado. Pídele a alguien que te revise.',
