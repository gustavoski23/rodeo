// @ts-nocheck
/* chromatic-text-reveal.tsx — animación de texto con barrido cromático
   (beui.dev/components/motion/text-animation), pegado por Gus. VERBATIM salvo
   el `// @ts-nocheck` de arriba (mismo trato que sign-up.tsx y el resto de
   componentes de librería: verbatimModuleSyntax + las CSS vars en props de
   motion exigirían retocar tipos, y los pegados no se editan). Sus imports
   `@/lib/ease` y `@/lib/utils` resuelven a los módulos del repo. */
"use client";
