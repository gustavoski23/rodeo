...
/* SUSCRIPCIÓN — overlay global del flujo de pago (DEMO VISUAL).
   ...
   El recorrido lo dicta el store (stores/suscripcion.ts):
     oferta   → la squishy card ($299/Month) con GET IT NOW
   ...
   TODO es de mentira: Subscribe y Place Order avanzan sin validar ni cobrar.
   Los paneles blancos llevan el scope .sub-claro (suscripcion.css); la
   squishy card no lo necesita — es índigo propio en cualquier tema. */
