/* dialog — shadcn/origin-ui pegado del prompt de Gus (flujo Suscripción),
   VERBATIM salvo dos adaptaciones declaradas:
   · sin "use client" (no es Next — misma regla que liquid-morph-floating-menu).
   · z-index [200]/[201] en vez de [101]: el overlay de Suscripción vive en
     z-[160..170] (por encima de las hojas z-[150] de talk/ladder) y el diálogo
     de pago tiene que quedar ENCIMA de ese velo.
   · `max-w-[calc(100%-2rem)] rounded-xl` TAMBIÉN bajo sm: el original era
     w-full a ras de borde y con esquinas cuadradas en móvil — a 390px el
     checkout debe seguir siendo el diálogo flotante redondeado de la captura. */
