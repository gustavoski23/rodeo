// @ts-nocheck
/* sign-up.tsx — componente de auth con estética "glass" (21st.dev), pegado por
   Gus. VERBATIM salvo: (1) `// @ts-nocheck` arriba (verbatimModuleSyntax del
   proyecto exigiría type-imports; el resto de componentes de librería reciben
   el mismo trato), y (2) `export` añadido a GradientBackground, BlurFade,
   GoogleIcon y los iconos nuevos AppleIcon/XIcon + un GlassStyles reutilizable,
   para que el gate de Hablarte reúse el vidrio EXACTO sin duplicar el CSS. La
   lógica, el CSS y el AuthComponent quedan tal cual. */
...
export const GradientBackground = () => (
    <>
        <style>
            {` @keyframes float1 { 0% { transform: translate(0, 0); } 50% { transform: translate(-10px, 10px); } 100% { transform: translate(0, 0); } } @keyframes float2 { 0% { transform: translate(0, 0); } 50% { transform: translate(10px, -10px); } 100% { transform: translate(0, 0); } } @media (max-width: 767px), (pointer: coarse), (prefers-reduced-motion: reduce) { .gate-gradient-motion { animation: none !important; } } `}
        </style>
        <svg width="100%" height="100%" viewBox="0 0 800 600" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" className="absolute top-0 left-0 w-full h-full">
            ...
            <g className="gate-gradient-motion" style={{ animation: 'float1 20s ease-in-out infinite' }}>
            ...
            <g className="gate-gradient-motion" style={{ animation: 'float2 25s ease-in-out infinite' }}>
...
/* Iconos añadidos para el gate de Hablarte (Apple y X/Twitter), mismo trazo que
   los de arriba, tomados de sus marcas oficiales monocromas. */
export const AppleIcon = (props: React.SVGProps<SVGSVGElement>) => ( <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" className="w-6 h-6"> <path fill="currentColor" d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 20.7-88.5 20.7-15 0-49.4-19.7-76.4-19.7C63.3 141.2 4 184.8 4 273.5q0 39.3 14.4 81.2c12.8 36.7 59 126.7 107.2 125.2 25.2-.6 43-17.9 75.8-17.9 31.8 0 48.3 17.9 76.4 17.9 48.6-.7 90.4-82.5 102.6-119.3-65.2-30.7-61.7-90-61.7-91.9zm-56.6-164.2c27.3-32.4 24.8-61.9 24-72.5-24.1 1.4-52 16.4-67.9 34.9-17.5 19.8-27.8 44.3-25.6 71.9 26.1 2 49.9-11.4 69.5-34.3z"/> </svg> );
export const XIcon = (props: React.SVGProps<SVGSVGElement>) => ( <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6"> <path fill="currentColor" d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/> </svg> );

/* Todo el CSS del vidrio (glass button + glass input) vive aquí, extraído
   VERBATIM del <style> del AuthComponent, para que el gate de Hablarte lo reúse
   sin AuthComponent. Montar <GlassStyles/> una vez basta. */
