...
/* sign-up.tsx — componente de auth con estética "glass" (21st.dev), pegado por
   ...
   para que el gate de RODEO reúse el vidrio EXACTO sin duplicar el CSS. La
...
/* Iconos añadidos para el gate de RODEO (Apple y X/Twitter), mismo trazo que
...
/* Todo el CSS del vidrio (glass button + glass input) vive aquí, extraído
   VERBATIM del <style> del AuthComponent, para que el gate de RODEO lo reúse
