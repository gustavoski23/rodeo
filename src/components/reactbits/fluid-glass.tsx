// @ts-nocheck
/* FluidGlass — React Bits (reactbits.dev), fuente pegada por Gus, VERBATIM.
   Única adaptación (declarada): el componente acepta `children` como contenido
   de la escena; si no llegan, cae al demo original (<Typography/> + <Images/>).
   ModeWrapper, Lens/Bar/Cube, materiales y parámetros quedan byte a byte.
   Modelos: public/assets/3d/{lens,bar,cube}.glb (del repo de React Bits). */
