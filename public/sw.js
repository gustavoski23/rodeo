...
// v11 = rebranding a HABLARTE: cambian los tres iconos, el manifest y el shell.
// Sin subir esto, quien ya tenga la app instalada seguiría viendo el icono y el
// nombre de RODEO — manifest e iconos son cache-first en STATIC_CACHE.
const VERSION = 'rodeo-v11';
...
// VERSION. Si esto pasara a 'hablarte-', las caches 'rodeo-v10-*' que ya viven
